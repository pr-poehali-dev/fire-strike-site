...
const MODES = [
  ...
  },
  {
    ...
    players: "5 на 5",
    duration: "30 раундов",
    desc: "Атака против защиты. Атакующие должны заложить и подорвать бомбу на одной из точек — защитники обязаны им помешать. Один раунд, один шанс.",
  },
];
...
const MAPS = [
  {
    ...
    type: "Закладка бомбы",
    size: "Средняя",
    desc: "Промышленный завод с трубами и конвейерами. Две точки закладки, множество обходных путей.",
  },
  {
    name: "Arabic",
    type: "Закладка бомбы",
    size: "Средняя",
    desc: "Восточный базар с узкими переулками и плоскими крышами. Снайперам здесь раздолье.",
  },
  {
    name: "Склад",
    type: "Deathmatch",
